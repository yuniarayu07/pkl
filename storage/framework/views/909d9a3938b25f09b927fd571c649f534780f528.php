...
<html class="fixed">
	<head>
		...
		<!-- Vendor CSS -->
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/bootstrap/css/bootstrap.css" />
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/font-awesome/css/font-awesome.css" />
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/magnific-popup/magnific-popup.css" />
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/bootstrap-datepicker/css/datepicker3.css" />

		<!-- Specific Page Vendor CSS -->
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/jquery-ui/css/ui-lightness/jquery-ui-1.10.4.custom.css" />
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/bootstrap-multiselect/bootstrap-multiselect.css" />
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/vendor/morris/morris.css" />

		<!-- Theme CSS -->
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/stylesheets/theme.css" />

		<!-- Skin CSS -->
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/stylesheets/skins/default.css" />

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="<?php echo e(assets('frontend')); ?>/stylesheets/theme-custom.css">
	...
	<body>
		...
		<!-- Vendor -->
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery/jquery.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-browser-mobile/jquery.browser.mobile.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/bootstrap/js/bootstrap.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/nanoscroller/nanoscroller.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/magnific-popup/magnific-popup.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-placeholder/jquery.placeholder.js"></script>
		
		<!-- Specific Page Vendor -->
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-appear/jquery.appear.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/bootstrap-multiselect/bootstrap-multiselect.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-easypiechart/jquery.easypiechart.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/flot/jquery.flot.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/flot-tooltip/jquery.flot.tooltip.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/flot/jquery.flot.pie.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/flot/jquery.flot.categories.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/flot/jquery.flot.resize.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jquery-sparkline/jquery.sparkline.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/raphael/raphael.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/morris/morris.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/gauge/gauge.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/snap-svg/snap.svg.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/liquid-meter/liquid.meter.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/jquery.vmap.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/data/jquery.vmap.sampledata.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/jquery.vmap.world.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/continents/jquery.vmap.africa.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/continents/jquery.vmap.asia.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/continents/jquery.vmap.australia.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/continents/jquery.vmap.europe.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js"></script>
		<script src="<?php echo e(assets('frontend')); ?>/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js"></script>
		
		<!-- Theme Base, Components and Settings -->
		<script src="<?php echo e(assets('frontend')); ?>/javascripts/theme.js"></script>
		
		<!-- Theme Custom -->
		<script src="<?php echo e(assets('frontend')); ?>/javascripts/theme.custom.js"></script>
		
		<!-- Theme Initialization Files -->
		<script src="<?php echo e(assets('frontend')); ?>/javascripts/theme.init.js"></script>


		<!-- Examples -->
		<script src="<?php echo e(assets('frontend')); ?>/javascripts/dashboard/examples.dashboard.js"></script>
	</body>
</html>